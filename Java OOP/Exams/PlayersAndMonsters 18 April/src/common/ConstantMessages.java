...
public class ConstantMessages {
    ...
    public static final String MIN_HEALTH_POINTS_LESS_THAN_ZERO
    ...
    public static final String PLAYER_CANNOT_BE_NULL
            = "Player cannot be null!";

    public static final String CARD_ALREADY_EXIST
